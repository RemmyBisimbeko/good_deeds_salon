...
class ServicesScreen extends StatefulWidget {
  ...
  const ServicesScreen({Key? key, required this.current_username})
      : super(key: key);
...
class ProfileState extends State<ServicesScreen> {
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return const Center(
                child: Text('Looks like you have not posted anything yet!'));
          }
